...
// Инициализируем AppKit-контекст: без живого NSApplication NSEvent.cgEvent в фоновом
// (launchd) процессе возвращает nil, и медиа-клавиши не постятся. Политика .prohibited —
// без иконки в доке.
...
func renderLCD(_ v: Int, _ muted: Bool) {           // всегда шлёт обе строки
